 ...
 */
public final class ITNativeLibraryLoader {
    ...
    private static final String NATIVE_LIBRARY_EXTENSION = OS_NAME.toLowerCase().contains("mac")
        ? ".dylib" : ".dll";
    private static final String NATIVE_LIBRARY_PREFIX = "lib";
    private static final Set<String> LOADED = new HashSet<>();
    private static Boolean libraryLoaded;

    private ITNativeLibraryLoader() {
    }

    /**
     * Loads the native jITLibrary library.
     *
    ...
    public static synchronized boolean loadLibrary() {
        ...
        if ("aarch64".equals(OS_ARCH) || "arm64".equals(OS_ARCH)) {
            ITNativeLibraryLoader.loadLibrary("jitlibrary-aarch64");
        } else {
            ITNativeLibraryLoader.loadLibrary("jitlibrary-x86_64");
        }
        libraryLoaded = true;
        return libraryLoaded;
    }
    ...
    public static synchronized void loadLibrary(final String libName) {
        loadLibrary(libName, ITNativeLibraryLoader.class);
    }
    ...
    private static String readProjectVersion() {
        try {
            ...
            properties.load(ITNativeLibraryLoader.class.getResourceAsStream("project.properties"));
